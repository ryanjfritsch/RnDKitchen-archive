...
export default class MealCard extends Component {
    ...
    render() {
        ...
        const mealImage = require('../images/headers/'+this.props.imageName+'.png');

        return(

            <div className="mealCard">
                <div>
                    <img className="cardImage" src={mealImage} alt="" style={{ width: "300", height: "300" }} />
                </div>
                <div className="mealCardLowerHalf">
                    ...
                    <StarsRating rating={ this.state.rating }></StarsRating>
                </div>
            </div>
        );
